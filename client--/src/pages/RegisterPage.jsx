    ...
    <div className="min-h-screen bg-[#08111F] flex items-center justify-center px-4">
      <div className="bg-[#0F1B2D] border border-[#263A57] rounded-xl p-7 sm:p-8 w-full max-w-md shadow-2xl shadow-sky-950/20">
        <div className="mb-7">
          ...
          <h1 className="mt-6 text-2xl font-bold tracking-tight text-[#E5EDF9]">Create your account</h1>
          <p className="mt-1 text-sm text-[#9DB0C9]">Save review history and keep your work in context.</p>
        </div>
        ...
        <div className="space-y-4">
          <div>
            <label className="text-[#9DB0C9] text-sm mb-1 block">Name</label>
            <input
              type="text"
              value={name}
        ...
        <p className="text-[#9DB0C9] text-sm text-center mt-5">
          ...
          <Link to="/login" className="text-[#7DD3FC] hover:text-[#BAE6FD] hover:underline">
            Sign In
          </Link>
        </p>
      </div>
